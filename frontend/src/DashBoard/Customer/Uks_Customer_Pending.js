        ...
        <tbody>
          {currentCustomers.map((customer, index) => (
            <tr key={customer._id} style={{ borderBottom: '1px solid #dddddd' }}>
              ...
              <td style={tdStyle}>{customer.customercontact}</td>
              <td style={tdStyle}>{customer.customerwhatsapp}</td>
              <td style={tdStyle}>{customer.customermailid}</td>
