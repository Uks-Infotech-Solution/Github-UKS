...
const DSA_Enquiry = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://uksinfotechsolution.in:8000/api/dsa/enquiry/form', formData)
      .then(response => {
        alert('Enquiry Successful');
        setFormData({ dsaname: '', companyname: '',contactNumber: '', email: '' }); // Clear the form
